...
reportingRouter.get("/matchReport",  roleMiddleware("Police", "Admin"), reportController.parentNameMatchWithMissingReport);
...
reportingRouter.put("/caseClose/:id",  roleMiddleware("Police", "Admin"), reportController.caseClose);
