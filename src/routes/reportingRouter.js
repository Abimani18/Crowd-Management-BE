...
reportingRouter.post("/matchReport",  roleMiddleware("Police", "Admin"), reportController.parentNameMatchWithMissingReport);

reportingRouter.post("/create", Auth, roleMiddleware("Police"),upload.single("childPhoto"), reportController.createFoundReport);
reportingRouter.post("/matchWithMissingReport",Auth, roleMiddleware("Police"),reportController.matchWithMissingReport);
reportingRouter.put("/caseClose/:id",  roleMiddleware("Police", "Admin"), upload.single("reporterImage"),reportController.caseClose);
